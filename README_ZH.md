...
## 简介
移动与智慧屏应用场景化接入华为帐号示例代码对华为帐号服务（HUAWEI Account Kit）常用接口在该场景下的使用提供了代码样例，方便您参考或直接使用。详情包括：
...
## 示例代码
Android应用场景化接入华为帐号示例代码客户端Java示例代码提供了以下使用场景：
1. 移动与智慧屏应用快速接入华为帐号。
...
## 运行结果
示例代码中点击华为帐号登录将拉起华为帐号登录授权页面，点击帐号退出将清楚缓存、点击取消授权按钮将取消应用授权等。
